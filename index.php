        ...
        <div id="loginBack" class="loginBack">
          ...
          <div class="loginPanel">
            <div class="loginGroup loginGroupUser" style="top:16px;">
              <span>Usuario</span>
              <input type="text" id="txt_UserName" tabindex="1" class="loginText" pattern="[A-Za-z0-9.]{1,30}" required placeholder="usuario..." autocomplete/>
            </div>
            <div class="loginGroup loginGroupUser" style="top:38px;">
              <span>Password</span>
              <input type="password" id="txt_UserPass" tabindex="2" class="loginText" required placeholder="password..." autocomplete="nope"/>
            </div>
          </div>
