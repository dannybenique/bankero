<?php
  ...
  switch ($data->TipoQuery) {
    ...
    case "insPago":
      ...
      /******agregamos bn_movim********/
      /********************************/
      $movimID = $fn->getValorCampo("select coalesce(max(id)+1,1) as code from bn_movim;", "code");
      $codigo = $userID."-".$fn->getValorCampo("select right('0000000'||cast(coalesce(max(right(codigo,7)::integer)+1,1) as text),7) as code from bn_movim where id_cajera=".$userID, "code");
