...
<section class="content-header">
  <h1><i class="fa fa-tasks"></i> CoopSUD Status Cajas</h1>
  <ol class="breadcrumb">
        ...
        <div class="box-header no-padding">
          <div class="mailbox-controls">
            ...
            <div class="btn-group">
              ...
              <button type="button" class="btn btn-success btn-sm" title="Descargar cancelados de esta agencia" onclick="javascript:rptGetStatusDownload();"><i class="fa fa-download"></i></button>
            </div>
          ...
          <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="grdDatos">
                <thead>
                  <tr>
                    <th style="width:50px;" title="Agencia">Agc</th>
                    <th style="width:50px;" title="Ventanilla">Vent</th>
                    <th style="width:50px;" title="Moneda">Mon</th>
                    <th style="width:50px;" title="Numero de operaciones">Opers</th>
                    <th style=""></th>
                  </tr>
                </thead>
...
<script src="pages/caja/status/business.js"></script>
<script>
