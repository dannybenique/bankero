      ...
      <div class="box box-primary">
        <div class="box-body">
          <div class="box-body table-responsive no-padding">
            ...
            <button type="button" id="btn_Borrar" class="btn btn-default btn-sm" onclick="javascript:appBorrarMovimiento();" title="Borrar Movimiento"><i class="fa fa-trash"></i></button>
            <button type="button" id="btn_Corregir" class="btn btn-default btn-sm" onclick="javascript:appCorregirSaldo();" title="Corregir Saldo y Movimientos"><i class="fa fa-chain"></i></button>
            <span id="div_reservado"></span>
            ...
            <table class="table table-hover" id="grdAhorros">
                <thead>
                  <tr>
                    ...
                    <th style="width:80px;text-align:center;" title="num_trans">Trans</th>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header" style="background:#f9f9f9;padding:8px;">
          ...
          <h4 class="modal-title fontFlexoRegular">Cambiar Monto</h4>
        </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="input-group">
                      <span class="input-group-addon" style="background:#f5f5f5;">Fecha</span>
                      <input id="txt_movimFecha" type="text" class="form-control" style="width:105px;"/>
                      <input id="hdn_movimHora" type="hidden"/>
                    </div>
                  </td>
                  <td style="width:40%">
                    <button type="button" class="btn btn-primary btn-sm" onclick="javascript:modCambiarFecha();"><i class="fa fa-flash"></i> Cambiar Fecha</button></td>
                </tr>
                <tr>
                  <td style="width:30%"></td>
                  <td>
                    <div class="input-group">
                      <span id="lbl_movimVoucher" class="input-group-addon" style="background:#f5f5f5;"></span>
                      <input id="txt_movimImporte" type="text" class="form-control" style="width:120px;"/>
                    </div>
                  </td>
                  <td style="width:30%">
                    <button type="button" class="btn btn-primary btn-sm" onclick="javascript:modCambiarImporte();"><i class="fa fa-flash"></i> Cambiar Importe</button></td>
                </tr>
              </table>
            </div>
          </div>
...
<script src="pages/coopsud/ahorrosX/ahorros.js"></script>
<script>
