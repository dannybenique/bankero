...
function appDocsGridAll(){
  $('#grdDatosBody').html('<tr><td colspan="3"><br><div class="progress progress-sm active"><div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" style="width:100%"></div></div></td></tr>');
  var datos = {
    TipoQuery : 'selDocsLogis'
  }
