...
<section class="content">
  <div class="row" id="grid">
    <div class="col-md-12">
      ...
      <br>
      <div id="div_info" class="callout callout-info" style="display:none;background:#39CCCC;">
        <h4>Agregar Nuevos Tipos de Credito</h4>
        <p>Para agregar nuevos tipos de credito se debe insertar en bn_tipos el codigo del tipo de credito con el codigo de la coopac</p>
      </div>
    </div>
  </div>
