<?php if(isset($menu->mtto->submenu->socios)){?>
...
<section class="content-header">
  <h1><i class="fa fa-gear"></i> <b>Socios</b></h1>
  <ol class="breadcrumb">
      ...
      <div class="box box-primary">
        <div class="box-header no-padding">
          <div class="mailbox-controls">
            <div class="btn-group">
              <button type="button" id="btn_DEL" class="btn btn-default btn-sm" onclick="javascript:appSociosBotonBorrar();"><i class="fa fa-trash"></i></button>
              <button type="button" id="btn_NEW" class="btn btn-default btn-sm" onclick="javascript:appSocioBotonNuevo();"><i class="fa fa-plus"></i></button>
            </div>
        ...
        <div class="box box-widget widget-user-2">
          ...
          <div class="no-padding">
            <ul class="list-group">
              ...
              <li class="list-group-item"><b>Agencia</b><a class="pull-right" id="lbl_Agencia" style="font:14px flexoregular;"></a></li>
            </ul>
          </div>
          <div class="box-body">
            <button id="btnCancel" type="button" class="btn btn-default" onclick="javascript:appSociosBotonCancel();"><i class="fa fa-angle-double-left"></i> Regresar</button>
            <button id="btnInsert" type="button" class="btn btn-primary pull-right" onclick="javascript:appSociosBotonInsert();"><i class="fa fa-save"></i> Guardar</button>
            <button id="btnUpdate" type="button" class="btn btn-info pull-right" onclick="javascript:appSociosBotonUpdate();"><i class="fa fa-save"></i> Actualizar</button>
          </div>
        </div>
      </div>
      <div class="col-md-9">
              ...
              <div class="box-body">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group" style="margin-bottom:5px;">
                      <div class="input-group">
                        <span class="input-group-addon" style="width:85px;background:#eeeeee;"><b>Agencia</b></span>
                        <select id="cbo_SocAgencia" class="form-control selectpicker"></select>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        <textarea id="txt_SocObserv" type="text" placeholder="Observaciones de socio..." cols="80" rows="10" style="width:100%;"></textarea>
                      </div>
                    </div>
...
<script src="pages/mtto/socios/script.js"></script>
<script>
